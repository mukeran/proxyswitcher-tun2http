...
Java_codes_var_tweak_proxyswitcher_VpnProxyService_nativeInit(JNIEnv *env, jobject instance) {
...
JNIEXPORT void JNICALL
Java_codes_var_tweak_proxyswitcher_VpnProxyService_nativeStart(
    ...
    if (thread_id && pthread_kill(thread_id, 0) == 0)
        ...
        args->fwd53 = fwd53;
        args->rcode = rcode;
        snprintf(args->proxyIp, sizeof(args->proxyIp), "%s", proxy_ip);
...
JNIEXPORT void JNICALL
Java_codes_var_tweak_proxyswitcher_VpnProxyService_nativeStop(
...
Java_codes_var_tweak_proxyswitcher_VpnProxyService_nativeGetMtu(JNIEnv *env, jobject instance) {
    return get_mtu();
}


JNIEXPORT void JNICALL
Java_codes_var_tweak_proxyswitcher_VpnProxyService_nativeDone(JNIEnv *env, jobject instance) {
